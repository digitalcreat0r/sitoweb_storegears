...
## 2. License and Use
A limited, non-transferable, and non-exclusive license is granted to use the website, tools, and applications in accordance with their intended purpose. You agree not to:
...
In no event shall the developer be liable for any indirect, incidental, or consequential damages (including loss of business data, profits, or store downtime) arising out of the use or inability to use the website or applications.
