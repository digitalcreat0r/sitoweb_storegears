...
*(Note: This policy applies to interactions on this website. Individual Shopify applications published by the developer have their own specific privacy policies detailing app-specific data processing, which can be accessed on the Shopify App Store or within each app).*
...
- **Contact & Feedback Information:** When you reach out via contact forms or email to share ideas, report issues, or ask for support, the developer collects your name (if provided), email address, and the content of your message.
...
This website uses minimal cookies strictly necessary for its core functionality. The developer does not use intrusive tracking cookies or sell your browsing data.
...
The developer reserves the right to update this Privacy Policy from time to time. Any changes will be posted on this page with an updated "Last updated" date.
